...
admin_messages = {
    ...
    'delete_requests': 'Here is a batch of delete requests 👆',
    'messages': 'Here is a batch of messages 👆',
    ...
    'usernamed_user_profile': 'Here is user profile 👇\n\n<a href="tg://user?id={0}">{0}</a>'
    ...
    'too_many_meme_tags': f'You can not add more than {settings.MAX_TAG_COUNT} tags !',
    ...
    'invalid_meme_description':'{0} description is invalid ⚠️',
...
user_messages = {
    ...
    'managing_playlist_member': 'مدیریت عضویت پلی لیست 🔗',
    'manage_meme': 'مدیریت {0} ⚙️',
    'manage_playlists': 'مدیریت پلی لیست ها 👇',
    'manage_playlist': 'مدیریت پلی لیست 👇',
    'manage_playlist_member': 'مدیریت عضویت پلی لیست 👇',
    ...
    'no_playlist_member': 'شما عضو هیچ پلی لیستی نیستید ⚠️',
    ...
    'playlist_member_deleted': 'عضویت در پلی لیست با موفقیت لغو شد ✖️',
    ...
    'playlist_link': ' شما به پلی لیست {0} دعوت شده اید !\nبرای عضویت بر لینک زیر کلیک کنید 👇\n\n{1}',
    ...
    'too_many_meme_tags': f'شما نمی توانید برای هر میم بیش از {settings.MAX_TAG_COUNT} تگ تعریف کنید ⚠️',
    ...
    'public_group': 'از طریق دکمه زیر وارد گروه شوید 👇'
}
